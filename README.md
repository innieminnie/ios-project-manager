...
### 1 - 1 ) ProjectManagerViewController
...
### 1 - 2 - 1 ) ProjectManagerViewController - SectionCollectionViewCell - 일정 상태 변경 (Drag And Drop)
...
### 1 - 2 - 2 ) ProjectManagerViewController - SectionCollectionViewCell - 일정 삭제
### 1 - 3 ) ProjectManagerViewController - 되돌리기/다시수행하기 (undo / redo)
...
- 해결방안<br>
    ...
    싱글톤패턴 사용 이유:<br> 앱 전역에서 발생하는 아이템 생성/이동/삭제 관련 내용에 대해 전부 추적해야하기 위해 싱글톤 HistoryManager 내의 historyContainer에 해당 내역들을 담아 tableView로 표현했습니다.<br><br>
---
